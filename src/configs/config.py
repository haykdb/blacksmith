...
# Symbol and Trading
SYMBOLS = ["FLMUSDT", "XLMUSDT"] # "BIOUSDT", "ZKUSDT", "ATAUSDT", "GUNUSDT", "CHESSUSDT", "GPSUSDT"]
...
STRATEGY_Z_EXIT = 0.5
TRADE_SLEEP = 0.2
SPREAD_MODEL_SLEEP = 3
TC = 0.0009
USE_WEBSOCKET = False
USE_MID_PRICE = True

# Logging
TRADE_LOG_PATH = "/Users/admin/Documents/BinanceBots/trades_history/{symbol}_{t:%Y-%m-%d}_trades.csv"
